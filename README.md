...
Render Link: https://canltn-service-agency.onrender.com
...
## Getting Started
Base URL: This application can be run locally. The hosted version is at `https://canltn-service-agency.onrender.com`.
...
#### GET /
 ...
 - Sample Request
   - `https://canltn-service-agency.onrender.com`
...
#### GET /actors
 ...
 - Sample Request
   - `https://canltn-service-agency.onrender.com/actors`
...
#### GET /actors/{actor_id}
 ...
 - Sample Request
   - `https://canltn-service-agency.onrender.com/actors/1`
...
#### PATCH /actors/{actor_id}
 ...
 - Sample Request
   - `https://canltn-service-agency.onrender.com/actors/5`
   - Request Body
     ```
       {
...
#### GET /movies
 ...
 - Sample Request
   - `https://canltn-service-agency.onrender.com/movies`
...
#### GET /movies/{movie_id}
 ...
 - Sample Request
   - `https://canltn-service-agency.onrender.com/movies/1`
...
#### PATCH /movie/{movie_id}
 ...
 - Sample Request
   - `https://canltn-service-agency.onrender.com/movies/3`
   - Request Body
     ```
       {
            "imdb_rating": 8.1
